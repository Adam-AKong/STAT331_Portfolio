...
ggplot(combined_data, aes(x = year.x, y = AveragePrice)) +
...
ggplot(combined_data, aes(x = year.x, y = index_nsa)) +
  geom_bar(mapping = aes(fill = region),
           position = "dodge", stat = "identity") +
  labs(
    x = "Year",
...
ggplot(combined_data) +
  geom_jitter(mapping = aes(x = AveragePrice, y = index_nsa, 
...
ggplot(combined_data) +
  geom_density(mapping = aes(x = index_nsa))
