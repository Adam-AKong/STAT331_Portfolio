...
ggplot(data = na.omit(surveys_date), 
...
ggplot(data = na.omit(dates_collapsed), 
       mapping = aes(x = level, 
                     y = n, 
                     fill = level )) +
  geom_col() +
...
ggplot(data = na.omit(new_dates2), 
